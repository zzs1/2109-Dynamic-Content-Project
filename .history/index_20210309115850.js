...
document.querySelector(".card").innerHTML += CardUI("What is 3rd Mental illness ?", "Bipolar disorder", "Anxiety disorder", "Major depressive disorder","Bipolar disorder","Symptoms  include experience <strong style='color:#FFF511;'>manic episodes</strong> where their moods and behaviors are drastically different than normal.");
...
document.querySelector(".headerpic").innerHTML += headerpicUI("headerpic1",'Shin_codecomps/headerpic/header.png',"HAVING THESE PROBLEM? Then it is time for you to look into the topic of");
